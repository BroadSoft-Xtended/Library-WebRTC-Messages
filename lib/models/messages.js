module.exports = require('bdsft-sdk-model')(Messages, {
...
function Messages(eventbus, urlconfig, sipstack) {
  ...
  self.bindings = {
    classes: {
        sipstack: ['registering', 'unregistering', 'connected', 'connecting', 'registered', 'registrationStatus', 'failed', 'userMediaFailed', 'sendVideo', 'receiveVideo'],
